...
// native_tensor_register.cpp registers them). Generated by brosurface
// (gen/emit_natives.mjs) from idl/tensor.idl; do not edit.
//
...
(function () {
    ...
    accessor(ns_tensor, "available",
        function () {
            return __bro_native.tensor.available;
        },
        undefined);
    ...
    // [manual] bro.tensor.createTensor: operation (rows, cols, dtype) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.cast: operation (src, dst, outDtype) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.softmaxForward: operation (logits, probs, mask) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.layernormForward: operation (x, gamma, beta, y, xhat, eps) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    fn(ns_tensor, "matmul", function matmul(A, B, C) {
        if (A === undefined) throw new TypeError("bro.tensor.matmul: A is required");
        if (B === undefined) throw new TypeError("bro.tensor.matmul: B is required");
        if (C === undefined) throw new TypeError("bro.tensor.matmul: C is required");
    ...
    // [manual] bro.tensor.attentionForward: operation (X, Wq, Wk, Wv, Wo, mask, Q, K, V, Attn, Y_pre_Wo, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.attentionBackward: operation (dO, X, Q, K, V, Attn, Y_pre_Wo, Wq, Wk, Wv, Wo, mask, dX, dWq, dWk, dWv, dWo) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.mhaForward: operation (X, Wq, Wk, Wv, Wo, mask, numHeads, Qh, Kh, Vh, Attnh, Yconcat, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.mhaBackward: operation (dO, X, Qh, Kh, Vh, Attnh, Yconcat, Wq, Wk, Wv, Wo, mask, numHeads, dX, dWq, dWk, dWv, dWo) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.selfAttentionForward: operation (X, Wq, Wk, Wv, Wo, mask, numHeads, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.selfAttentionForwardTrain: operation (X, Wq, Wk, Wv, Wo, mask, numHeads, Qh, Kh, Vh, Attnh, Yconcat, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.selfAttentionBackward: operation (dO, X, Qh, Kh, Vh, Attnh, Yconcat, Wq, Wk, Wv, Wo, mask, numHeads, dX, dWq, dWk, dWv, dWo) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.crossAttentionForward: operation (X, Ctx, Wq, Wk, Wv, Wo, mask, numHeads, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.crossAttentionForwardWithAttn: operation (X, Ctx, Wq, Wk, Wv, Wo, mask, attnLogitBias, numHeads, O, AttnAvg) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.crossAttentionForwardTrain: operation (X, Ctx, Wq, Wk, Wv, Wo, mask, numHeads, Qh, Kh, Vh, Attnh, Yconcat, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.crossAttentionBackward: operation (dO, X, Ctx, Qh, Kh, Vh, Attnh, Yconcat, Wq, Wk, Wv, Wo, mask, numHeads, dX, dCtx, dWq, dWk, dWv, dWo) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.selfAttentionBiasForward: operation (X, Wq, Wk, Wv, Wo, mask, attnBias, numHeads, scale, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionForward: operation (Q, K, V, mask, numHeads, causal, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionWindowedForward: operation (Q, K, V, mask, numHeads, window, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionBackward: operation (Q, K, V, O, dO, mask, numHeads, causal, dQ, dK, dV) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionQkvoForward: operation (X, Ctx, Wq, bq, Wk, bk, Wv, bv, Wo, bo, mask, numHeads, causal, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionQkvoBackward: operation (opts) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionProjectKv: operation (ctx, Wk, bk, Wv, bv, K_out, V_out) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.flashAttentionQWithKvCachedForward: operation (X, K, V, Wq, bq, Wo, bo, mask, numHeads, causal, O) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.conv2dForward: operation (X, Wt, bias, N, C_in, H, W, C_out, kH, kW, sH, sW, pH, pW, dH, dW, groups, Y) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.resblockForward: operation (opts) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.resblockBackward: operation (opts) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.maskedMeanPoolForward: operation (X, mask, y) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.maskedMeanPoolBackward: operation (dY, mask, K, dX) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.softmaxXentFused: operation (logits, target, mask, probs, dLogits) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.softmaxXentFusedBatched: operation (logits_BL, target_BL, mask, headOffsets, n_heads, probs_BL, dLogits_BL, lossPerSample) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.concatRows: operation (parts, out) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.splitRows: operation (in_, parts) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.concatBatchedRows: operation (parts, out) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.concatNchwChannels: operation (parts, N, H, W, C_per_part, out) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    // [manual] bro.tensor.concatNchwChannelsBackward: operation (dY, N, H, W, C_per_part, dParts) — no native is generated; hand-written JS
    // installs it on ns_tensor after this module has run.
    ...
    // [manual] bro.tensor.GpuTensor.prototype.resize: operation (rows, cols, dtype) — no native is generated; hand-written JS
    // installs it on GpuTensor.prototype after this module has run.
    ...
    // [manual] bro.tensor.GpuTensor.prototype.upload: operation (src) — no native is generated; hand-written JS
    // installs it on GpuTensor.prototype after this module has run.
    // [manual] bro.tensor.GpuTensor.prototype.download: operation (dst) — no native is generated; hand-written JS
    // installs it on GpuTensor.prototype after this module has run.
