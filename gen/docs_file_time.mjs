// gen/docs_file_time.mjs - File API and Time API documentation page formatters for brosurface
// Formats out/docs/file-api.js and out/docs/time-api.js with 100% fidelity to bro reference docs

/**
 * Emits time-api.js documentation from AST.
 * @param {Object} fileAst
 * @returns {string}
 */
export function emitTimeDoc(fileAst) {
  return `/**
...
/**
 * Emits file-api.js documentation from AST.
 * @param {Object} fileAst
 * @returns {string}
 */
export function emitFileDoc(fileAst) {
  return `// =============================================================================
