// gen/docs_noise.mjs - FastNoise2 documentation page formatter for brosurface
// Formats out/docs/noise-api.js with 100% fidelity to bro reference docs

/**
 * Emits noise-api.js documentation.
 * @param {Object} fileAst
 * @returns {string}
 */
export function emitNoiseDoc(fileAst) {
  return `// =============================================================================
